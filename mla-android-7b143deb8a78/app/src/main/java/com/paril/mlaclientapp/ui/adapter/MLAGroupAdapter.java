 ...
 */
public class MLAGroupAdapter extends RecyclerSwipeAdapter<MLAGroupAdapter.SimpleViewHolder> {
    ...
    public class SimpleViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final MLAGroupDetails1 item, final OnItemClickListener listener) {
    ...
    private List<MLAGroupDetails1> mDataset;

    OnItemClickListener<MLAGroupDetails1> listener;


    //protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);

    public MLAGroupAdapter(Context context, List<MLAGroupDetails1> objects, boolean isSwipable, OnItemClickListener<MLAGroupDetails1> onItemClickListenerener) {
    ...
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        ...
        MLAGroupDetails1 item = mDataset.get(position);
