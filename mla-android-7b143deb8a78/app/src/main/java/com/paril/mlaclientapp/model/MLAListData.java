...
public class MLAListData {
    ...
    public HashMap<String,List<MLAListModel>> getlist()  {
        ...
        if(userType.equals("admin"))
        {
            ...
            List<MLAListModel> facebook = new ArrayList<MLAListModel>();
            List<MLAListModel> subjects = new ArrayList<>();
            List<MLAListModel> group = new ArrayList<>();
            List<MLAListModel> groupfriend = new ArrayList<>();
           // group.add(new MLAListModel("GroupFriend"));
            ...
            navDrawerHashMap.put("Facebook",facebook);
            navDrawerHashMap.put("Subject", subjects);
            navDrawerHashMap.put("Group", group);
            navDrawerHashMap.put("Groupfriend", group);
