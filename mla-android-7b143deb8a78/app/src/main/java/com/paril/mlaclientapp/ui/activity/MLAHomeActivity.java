...
import com.paril.mlaclientapp.ui.fragment.MLAFacebookViewFragment;
...
public class MLAHomeActivity extends BaseActivity {
    ...
    public void onHomeClick() {
        ...
        switch (userTypeData.getUserType()) {
            ...
            case UserTypeData.FACEBOOK:
                MLAFacebookViewFragment displayTask1 = new MLAFacebookViewFragment();
                fragmentTransaction.replace(R.id.mla_fragmentholder, displayTask1);
                fragmentTransaction.commit();
                break;
        }
    }
    ...
    public void openGroup() {
        ...
        lastGroupSelPos = 5;
        MLAGroupViewFragment infoFragment = new MLAGroupViewFragment();
        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.mla_fragmentholder, infoFragment);
        fragmentTransaction.commit();
    ...
    public void openGroupfreind() {
        setToolbarTitle("GroupFriend");
        lastGroupSelPos = 7;
        MLAGroupViewFragment infoFragment = new MLAGroupViewFragment();
        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
    ...
    public void openFacebook() {
        ...
        if (user.userType.equalsIgnoreCase(UserTypeData.INSTRUCTOR)) {
            MLAFacebookViewFragment infoFragment = new MLAFacebookViewFragment();
            FragmentManager fragmentManager = getFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.mla_fragmentholder, infoFragment);
            fragmentTransaction.commit();
    ...
    ///
                        } else if (listPrimary.get(groupPosition).equals("Facebook")) {
                                setToolbarTitle("Facebook");
                               MLAFacebookViewFragment infoFragment = new MLAFacebookViewFragment();
                                FragmentManager fragmentManager = getFragmentManager();
                                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                            ...
                            fragmentTransaction.commit();
                            //
                        } else if (listPrimary.get(groupPosition).equals("Group")) {
                            setToolbarTitle("Group");
                            MLAGroupViewFragment infoFragment = new MLAGroupViewFragment();
                            FragmentManager fragmentManager = getFragmentManager();
                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
